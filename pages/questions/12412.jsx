...
export default function question12412(){

    const question = questions.filter(item => item.questionId === 12412);
                    ...
                    {question.map((item) => (
                        <div className={styles.questionItem}>
                            ...
                            <div className={styles.lineFive}>
                                <Zoom className={styles.image} key={item.id} src={item.img} layout={"fixed"} width={96} height={96}/>
                                <Zoom className={styles.image} key={item.id} src={item.addImg01} layout={"fixed"} width={96} height={96}/>
                                <Zoom className={styles.image} key={item.id} src={item.addImg02} layout={"fixed"} width={96} height={96}/>
                            </div>
